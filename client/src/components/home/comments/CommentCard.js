            ...
            <div className="flex-fill"
                        ...
                        : <div>
                            ...
                            {content.length > 100 &&
                                <span className="readMore" onClick={() => setReadMore(!readMore)}>
                                    {t('readMore', { lng: languageReducer.language })}
                                </span>
                            }
                        </div>
                }
                ...
                <div style={{ cursor: 'pointer' }}>
                    ...
                    <small className="font-weight-bold mr-3">
                        {comment.likes.length} {t('likes', { lng: languageReducer.language })}
                    </small>
                        ...
                        onEdit
                            ? <>
                                <small className="font-weight-bold mr-3" onClick={handleUpdate}>
                                    {t('update', { lng: languageReducer.language })}
                                </small>
                            ...
                            : <small className="font-weight-bold mr-3" onClick={handleReply}>
                                {onReply ? t('cancel', { lng: languageReducer.language }) : t('reply', { lng: languageReducer.language })}
                            </small>
                    }
                </div>
            </div>
